...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Абитуриенты
        Abiturient ab1 = new Abiturient(++ids[0],"Николай","Серый");
        Abiturient ab2 = new Abiturient(++ids[0],"Олег","Сутулый");
        Abiturient ab3 = new Abiturient(++ids[0],"Екатерина","Щербакова");
        Abiturient ab4 = new Abiturient(++ids[0],"Марат","Вялый");
        Abiturient ab5 = new Abiturient(++ids[0],"Мария","Красивая");
        Abiturient ab6 = new Abiturient(++ids[0],"Александр","Смелый");
        Abiturient ab7 = new Abiturient(++ids[0],"Евгений","Душный");
        Abiturient ab8 = new Abiturient(++ids[0],"Стелла","Томная");
        Abiturient ab9 = new Abiturient(++ids[0],"Вероника","Лесная");
        //Преподователи
